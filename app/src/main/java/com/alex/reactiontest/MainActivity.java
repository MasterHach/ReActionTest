...
//
//import com.alex.reactiontest.database.ReactionRepository;
...
//        String lolkek = "Anonimous";
//        if (currentUser != null) {
//            lolkek = currentUser.getUid();
//        }
...
//        String finalLolkek = lolkek;
//        myRef.addListenerForSingleValueEvent(new ValueEventListener() {
//            @Override
//            public void onDataChange(@NonNull DataSnapshot snapshot) {
//
//                Long lolkek2 = snapshot.child(finalLolkek).child("memory_game_counter").getValue(Long.class);
